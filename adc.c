...
void ADC3powerUpInit(int temp_enable) {
    ...
    //        ADC_OVERSAMPLING_SHIFT_8B, ADC_OVERSAMPLING_RATIO_MUL16); //Configura oversampling 16-bit
    //adc_oversample_mode_enable (ADC0);                                  //Enable -''-

    if (temp_enable) {                                                          // Add Ch16 Temp?
